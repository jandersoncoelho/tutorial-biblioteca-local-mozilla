    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Informe uma breve descrição do livro', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Informe o gênero do livro (Ex.: Ficção Cientifica ', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'Manutenção'), ('e', 'Em Empréstimo'), ('d', 'Disponível'), ('r', 'Reservado')], default='m', help_text='Disponibilidade do Livro', max_length=1)),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Selecione o gênero do livro', to='catalog.genre'),
        ),
    ]
